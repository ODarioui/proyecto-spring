...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    EmployeeServiceImpl(EmployeeRepository employeeRepository, DepartmentHeadRepository departmentHeadRepository,
    ...
    public void updateDepartmentPos(Long id, Long newDepartmentId, String newPosition) {
        ...
        departmentRepository.findById(newDepartmentId)
                .orElseThrow(
                        () -> new IllegalArgumentException("No existe el departamento con el id: " + newDepartmentId));
    ...
    public int calculateAvailableVacationDays(Long employeeId) {
        ...
        int consumedDays = absenceRepository.findByEmployee(foundEmployee).stream()
                .filter(absence -> "Vacaciones".equalsIgnoreCase(absence.getAbsenceType())
